...
func getSecret() (string, error) {
	...
	var secretStruct models.Secret
...
func getClusterID(secret string) (models.ClusterItems, error) {
	...
	var clusters models.ClusterItems
...
func handleRequest(ctx context.Context, event json.RawMessage) (string, error) {
	var toBePausedClusters models.ClustersToBePaused
